    ...
    <div class="wrap-admin-link" v-if="auth.status==='success'">
        <div class="max">
            <div class="admin-link-text">
                ...
                <div class="wrap-menu">
                    <span class="menu"> <router-link to="/profile">Профиль</router-link> </span>
                    <span class="menu" v-if="auth.permission==='admin'"> <router-link to="/admin">Профиль</router-link> </span>
                </div>
